...
const Product = ({product, cart, setCart}) => {
  ...
  return (
    <div className='cart border border-black w-40 items-center justify-center text-center p-2'>
        ...
        {cart.includes(product) ? <button className='border bg-red-600 p-1 rounded bg-slate-600 text-white hover:bg-green-500 hover:shadow-md hover:text-lg' onClick={removeCart}>Remove from Cart</button> : 
